...
void TIMER1_INI(){
    ...
    TMR1L = 0x89;                 //el timer contará 1200 fosc/4 * 1 = 12032 * 0,0833us
    TMR1H = 0xFE;                //en total aprox 10ms
...
void EEwrite2(unsigned char addr,unsigned char n) {    // non uso puntatore, xché va a finire a 16bit! SPRECONI!
...
unsigned char EEread2(unsigned char addr) {
